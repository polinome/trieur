...
class Trieur extends atoum
{
    ...
    public function testConstruct()
    {
        ...
        $conf = Loader::load([
            'driver' => [
                'class' => '\Polinome\Trieur\Driver\Csv',
                'conf' => [
                    'itemName' => 'objet',
                    'itemsName' => 'objets',
                    'itemsGenre' => '',
            ...
            'source' => [
                'class' => '\Polinome\Trieur\Source\Doctrine',
                'conf' => [
                    'select' => 'a',
                    'from' => [
                        'name' => 'table01',
        ...
        $this
            ...
            ->hasMessage('class "\stdClass" does not extend abstract class "\Polinome\Trieur\Driver"')
        ;
        $conf = Loader::load([
            'driver' => [
                'class' => '\stddddClass',
        ...
        $this
            ...
            ->hasMessage('class "\PDO" does not extend abstract class "\Polinome\Trieur\Source"')
        ;
    ...
    public function testGet()
    {
        ...
        $this
            ...
            ->object($trieur->getDriver())
                ->isInstanceOf('\Polinome\Trieur\Driver\DataTables')
            ->object($trieur->getSource())
                ->isInstanceOf('\Polinome\Trieur\Source\Doctrine')
            ->object($trieur->setRequest([]))
                ->isInstanceOf('\Polinome\Trieur\Trieur')
        ;
    }
            ...
            'columns' => [
                '4' => [
                    'format' => [
                        ...
                        'name' => [
                            '\Polinome\Trieur\Example\Format',
                            'sqlTo',
                        ],
                        'cell' => 'dateSql',
                        'arguments' => [
